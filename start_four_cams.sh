...
HEAD_CAM="${HEAD_CAM:-/dev/video4}"
LEFT_WRIST_CAM="${LEFT_WRIST_CAM:-/dev/video2}"
RIGHT_WRIST_CAM="${RIGHT_WRIST_CAM:-/dev/video0}"
PICO_STEREO_CAM="${PICO_STEREO_CAM:-/dev/video6}"
